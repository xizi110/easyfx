 ...
 * @since 2016-03-09
 */
public class EleSliderSkin extends SliderSkin {
    ...
    public EleSliderSkin(EleSlider slider) {
        super(slider);
    ...
    private void refreshSliderValueBinding() {
        ...
        if (((EleSlider) getSkinnable()).getValueFactory() != null) {
            sliderValue.textProperty()
                    .bind(((EleSlider) getSkinnable()).getValueFactory().call((EleSlider) getSkinnable()));
        } else {
    ...
    private void initializeVariables() {
        ...
        if (((EleSlider) getSkinnable()).getIndicatorPosition() != EleSlider.IndicatorPosition.LEFT) {
    ...
    private void initAnimation(Orientation orientation) {
        ...
        if (orientation == Orientation.HORIZONTAL) {
            if (((EleSlider) getSkinnable()).getIndicatorPosition() == EleSlider.IndicatorPosition.RIGHT) {
