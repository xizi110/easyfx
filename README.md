...
2. 新建一个类，继承`xyz.yuelai.View`类，实现`public String fxml()`方法，此方法指定fxml文件位置。可以指定绝对路径，也可以指定相对路径。
   fxml文件路径如图所示
   ![image-20201009170359938](C:\Users\zhong\AppData\Roaming\Typora\typora-user-images\image-20201009170359938.png)
...
4. 启动程序
   ![image-20201009170622248](C:\Users\zhong\AppData\Roaming\Typora\typora-user-images\image-20201009170622248.png)
